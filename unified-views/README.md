...
| configuration.rdf4j.passwordSecret.key | string | `"password"` |  |
| configuration.rdf4j.passwordSecret.name | string | `""` |  |
| configuration.rdf4j.platform | string | `"remoteRDF"` |  |
| configuration.rdf4j.repoInit.enabled | bool | `true` |  |
| configuration.rdf4j.repoInit.timeout | string | `"1m"` |  |
| configuration.rdf4j.repositoryName | string | `"uv"` |  |
| configuration.rdf4j.url | string | `""` |  |
| configuration.rdf4j.user | string | `""` |  |
| configuration.sso.keycloak.adminRoles[0] | string | `"Administrator"` |  |
...
| configuration.sso.keycloak.oidcClientSecret.key | string | `"token"` |  |
| configuration.sso.keycloak.oidcClientSecret.name | string | `"uv-keycloak-sso-secret"` |  |
| configuration.sso.keycloak.realm | string | `""` |  |
| configuration.sso.keycloak.url | string | `"http://keycloak.127.0.0.1.nip.io/auth"` |  |
...
| nodeSelector | object | `{}` |  |
| persistence.emptyDir.sizeLimit | string | `"2Gi"` |  |
...
| persistence.volumeClaimTemplate.spec.resources.requests.storage | string | `"10Gi"` |  |
...
| rdf4j.persistence.emptyDir.sizeLimit | string | `"2Gi"` |  |
...
| rdf4j.persistence.volumeClaimTemplate.spec.resources.requests.storage | string | `"10Gi"` |  |
...
| rdf4j.tomcatVolume.volumeClaimTemplate.annotations | object | `{}` |  |
| rdf4j.tomcatVolume.volumeClaimTemplate.labels | object | `{}` |  |
| rdf4j.tomcatVolume.volumeClaimTemplate.name | string | `"tomcat"` |  |
| rdf4j.tomcatVolume.volumeClaimTemplate.spec.accessModes[0] | string | `"ReadWriteOnce"` |  |
| rdf4j.tomcatVolume.volumeClaimTemplate.spec.resources.requests.storage | string | `"10Gi"` |  |
...
| tolerations | list | `[]` |  |
| tomcatVolume.volumeClaimTemplate.annotations | object | `{}` |  |
| tomcatVolume.volumeClaimTemplate.labels | object | `{}` |  |
| tomcatVolume.volumeClaimTemplate.name | string | `"tomcat"` |  |
| tomcatVolume.volumeClaimTemplate.spec.accessModes[0] | string | `"ReadWriteOnce"` |  |
| tomcatVolume.volumeClaimTemplate.spec.resources.requests.storage | string | `"10Gi"` |  |
