...
```shell
# The command assumes you are in the "/poolparty" directory of the repository
# and there is a values_overrides.yaml file in it
helm upgrade --install poolparty -n <namespace> --values ./values_overrides.yaml ./
```
