...
| configuration.graphdb.password | string | `"root"` |  |
| configuration.graphdb.url[0] | string | `"http://graphdb:7200"` |  |
| configuration.graphdb.username | string | `"admin"` |  |
| configuration.index.type | string | `"elasticsearch"` |  |
| configuration.index.url | string | `"http://elasticsearch:9200"` |  |
| configuration.javaArguments | string | `""` |  |
| configuration.keycloak.admin.clientId | string | `"admin-cli"` |  |
| configuration.keycloak.admin.clientSecret | int | `123456` |  |
| configuration.keycloak.admin.password | string | `"admin"` |  |
| configuration.keycloak.admin.realm | string | `"master"` |  |
| configuration.keycloak.admin.username | string | `"poolparty_auth_admin"` |  |
| configuration.keycloak.login.clientId | string | `"ppt"` |  |
| configuration.keycloak.login.clientSecret | int | `654321` |  |
| configuration.keycloak.login.enableBasicAuth | bool | `true` |  |
| configuration.keycloak.login.principalAttribute | string | `"preferred_username"` |  |
| configuration.keycloak.login.realm | string | `"poolparty"` |  |
| configuration.keycloak.url | string | `"http://keycloak:8080/auth"` |  |
...
| license.mountPath | string | `"/usr/share/poolparty/config/licenses"` |  |
...
| Name | Email | Url |
| ---- | ------ | --- |
| Graphwise DnD Team | <dnd@graphwise.ai> |  |
