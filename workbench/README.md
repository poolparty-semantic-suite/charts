...
| Helm chart version | Semantic Workbench version  | Notes                    |
|--------------------|-----------------------------|--------------------------|
| 0.1.x              | 2.4.x                       |                          |
| 1.0.x              | 2.5.x                       | ⚠️ Configuration changes |
...
3. Install Semantic Workbench
    ...
    ```shell
    helm install semantic-workbench poolparty-semantic-suite/workbench
    ```
...
configuration:
  properties:
    ...
    SPRING_SECURITY_OAUTH2_CLIENT_REGISTRATION_PPT_CLIENTSECRET: yaOd67b2HdQ28hmvuWvZMpn3TLrmhZ1u
