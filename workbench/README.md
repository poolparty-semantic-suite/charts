...
configuration:
  properties:
    ...
    KEYCLOAK_PUBLIC_URL: http://keycloak.127.0.0.1.nip.io:8080/auth
...
| configuration.properties.KEYCLOAK_INTERNAL_URL | string | `"http://keycloak-service.keycloak:8080/auth"` |  |
| configuration.properties.KEYCLOAK_PUBLIC_URL | string | `"http://keycloak.127.0.0.1.nip.io/auth"` |  |
| configuration.properties.POOLPARTY_URL | string | `"http://poolparty.127.0.0.1.nip.io"` |  |
