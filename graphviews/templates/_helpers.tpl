...
*/}}
{{- define "graphviews.combinedImagePullSecrets" -}}
  {{- $secrets := concat .Values.global.imagePullSecrets .Values.image.pullSecrets }}
  {{- tpl (toYaml $secrets) . -}}
{{- end -}}

{{/*
Renders the container image for GraphViews.
*/}}
{{- define "graphviews.image" -}}
...
{{/*
Renders the external GraphViews URL.
*/}}
{{- define "graphviews.external-url" -}}
